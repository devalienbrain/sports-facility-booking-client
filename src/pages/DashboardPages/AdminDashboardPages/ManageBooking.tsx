...
// import { FaEdit, FaTrashAlt } from "react-icons/fa";
// import { TBooking } from "@/types/booking.type";
// import { useGetFacilityByIdQuery } from "@/redux/api"; // Assuming you have a query for fetching facility by ID
// // import { useGetUserByIdQuery } from "@/redux/api"; // Assuming you have a query for fetching user by ID
...
//         <tbody>
//           {bookings?.data.map((booking: TBooking, index) => {
//             // Fetch facility and user data based on IDs
//             const { data: facility } = useGetFacilityByIdQuery(
//               booking.facilityId
//             ); // Fetch facility details
//             const { data: user } = useGetUserByIdQuery(booking.userId); // Fetch user details
...
//                 <td className="py-3 px-6 border-b">
//                   <div>
//                     <p className="font-bold">{facility?.name || "N/A"}</p>
//                     <p className="text-sm text-gray-500">
//                       Price per hour: {facility?.pricePerHour || "N/A"}
//                     </p>
//                   </div>
//                 </td>
//                 <td className="py-3 px-6 border-b">
...
//                 <td className="py-3 px-6 border-b flex items-center space-x-4">
//                   <Link
//                     to={`/dashboard/updateBooking/${booking._id}`} // Updated link to reflect booking ID
//                     className="text-blue-500 hover:text-blue-700"
//                     title="Change Booking"
//                   >
//                     <FaEdit size={20} />
