      ...
      <table className="min-w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        <thead className="bg-blue-500 text-white">
          <tr>
            ...
            <th className="py-3 px-5 text-left">Price/hour</th>
          ...
          {facilities &&
            facilities?.data?.map((facility, index) => (
              ...
              >
                ...
                <td className="py-3 px-5 border-b text-sm text-gray-600 font-semibold">
...
// import { FaRegEdit } from "react-icons/fa";
// import { TiDelete } from "react-icons/ti";
// import { TFacility } from "@/types/facility.type"; // Adjust this import as necessary

// const ManageFacilities: React.FC = () => {
//   // Make sure to return the correct type from the query
//   const {
//     data: facilities,
//     error,
//     isLoading,
//     refetch,
//   } = useGetFacilitiesQuery(); // Adjust if necessary to specify the expected return type
...
//             (
//               facility: TFacility,
//               index: number // Explicitly set the index type
//             ) => (
//               <tr
//                 key={facility._id}
//                 className="hover:bg-gray-100 transition duration-200"
